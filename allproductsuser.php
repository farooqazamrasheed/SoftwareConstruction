...
<body>
    ...
    <div class="row p-0 mx-0 m-0" style="margin-left:0px; margin-right:0px">
    ...
    <div class="row m-0">
                ...
                $showcat = "SELECT * from products where category_id= $catid";
                ...
                if ($resultcat->num_rows > 0) {
                    ...
                    ?>
                    <p style="margin-top:20px;font-size:25px; margin-left:0px;padding:0px;color:grey">No Products Yet</p>
                    <?php
                }
                ?>
            </div>
