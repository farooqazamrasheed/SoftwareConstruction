...
<?php include 'accordian.php'?>
            ...
            <div class="col-lg-9 greybg" style="padding:0px !important">
                <div class="container">
                    <h3 style="margin-top:90px;">Auction Status</h3>
                </div>
                ...
                $showproducts = "SELECT * from products where seller_id='$sellerid'";
                        ...
                        <div class="row m-0">
                            ...
                            $result = $conn->query($sql);
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        <h6 style="" class="text-center mb-3"><b>You can now contact the bidder  at: </b> </h6>
                                                <?php
                                                $findbidder = "SELECT * FROM user where userid='$bidder_id'" ;
                                                
                                                $getbidder = mysqli_query($conn, $findbidder);
                                                $getbidderinfo = $getbidder->fetch_assoc();
                                                ?>
                                                <h6 style="" class="text-center mb-3"><b>
                                                    <?php   echo $getbidderinfo['email']; ?> </b> </h6>
                                            ...
                                            if ($getallbids->num_rows > 0) {
                                                ...
                                                while ($getallbidsresult = $getallbids->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php  $bidder_id = $getallbidsresult['buyer_Id'];
